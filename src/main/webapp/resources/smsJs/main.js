...
$(function() {
	...
	//}
	/*$("#select_themes_list").change(function(){
		    var theme = $(this).val();
	...
	$.fn.zTree.init($("#menu_tree"),
			{
				...
				callback : {
					onClick : function(event, treeId, treeNode, clickFlag) {
						if (treeNode.resourcePath) {
							var sys = MAIN_SYS_DATA[treeNode.sysFlag];
							var menuUrl = buildURL(sysDomain,
									treeNode.resourcePath);
							addTab(treeNode.resourceName, menuUrl, true);
						}
					}
				}
