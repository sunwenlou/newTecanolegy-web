<%@page import="com.sun.wen.lou.newtec.shiro.CasUtil"%>
...
<body class="easyui-layout">
	<div region="north" split="false" border="false">
		<div class="header">
			<div class="dl-log">
				欢迎您 &nbsp; ${realName}，<span class="dl-log-user" id="update"></span>&nbsp;&nbsp;今天是<span
					id="linkweb"></span> <a href="${ctx}/main/logout" title="退出系统" class="dl-log-quit">[退出]</a><br>
						<c:forEach var="accountinfo" items="${accountlist}">
						      <div id="main${accountinfo.key}Balances">
								<c:forEach var="info"  items="${accountinfo.value}">
									${info.smsDictionaryName}余额为:${info.smsBalances}条
								</c:forEach>
							</div>
						</c:forEach>
					</div>
