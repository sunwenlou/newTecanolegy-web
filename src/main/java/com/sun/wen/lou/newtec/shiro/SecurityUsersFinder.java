...
import com.sun.wen.lou.newtec.shiro.PurviewInfo;
import com.sun.wen.lou.newtec.shiro.PurviewUsers;
import com.sun.wen.lou.newtec.shiro.SecurityUsers;
import com.sun.wen.lou.newtec.shiro.ISecurityUsersFinder;
...
public class SecurityUsersFinder implements ISecurityUsersFinder {
	...
	private static final String system_type = "UUCTec";
...
/*	@Resource(name = "redisManager")
	...
	public PurviewUsers getPurviewUsers(String accountId) {
		// 根据用户名查询redis左边菜单
		String menuJson = getMenusFromInterface(system_type, accountId);
...
//				}
	...
	public List<PurviewInfo> getAllPurivewInfos() {
		// 根据用户名查询redis左边菜单
		String menuJson = getAllMenusFromInterface(system_type);
